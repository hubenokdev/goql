module github.com/hubenokdev/goql
...
require (
	...
	github.com/anixy/hackernews v0.0.0-20220331104412-e2a84f5c1b72 // indirect
	...
	github.com/hubenokdev/goql/go-graphql-hackernews/internal/pkg/db/migrations/mysql v1.0.0
)
